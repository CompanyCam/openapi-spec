...
exports.getSupportedFeatures = void 0;
const analyzer_1 = __importDefault(require("oas/dist/analyzer"));
...
async function analyzeOas(definition) {
    return (0, analyzer_1.default)(definition).then((analysis) => {
        if (analysis.openapi) {
